...
public:
  ...
  virtual void visit (ArrayDeclarationNode* node); // Done
  virtual void visit (ParameterNode* node); //Done

  virtual void visit (StatementNode* node); //Eric done
  virtual void visit (CompoundStatementNode* node); // done
  virtual void visit (IfStatementNode* node); //Eric done
  virtual void visit (WhileStatementNode* node); // done
  virtual void visit (ForStatementNode* node); //Eric done
  virtual void visit (ReturnStatementNode* node); // Done
  ...
  virtual void visit (CallExpressionNode* node); // done
  ...
  virtual void visit (UnaryExpressionNode* node); // done
...
struct VariableDeclarationNode;
//Not Done
struct ArrayDeclarationNode; //I

// Statement Nodes
struct StatementNode; //E
struct CompoundStatementNode; //I
struct IfStatementNode; //E
struct WhileStatementNode;// I
struct ForStatementNode; //E
struct ReturnStatementNode;//I
struct ExpressionStatementNode;//E

// Expression Nodes
struct ExpressionNode;//I
struct AssignmentExpressionNode;//E
struct VariableExpressionNode;//I
struct SubscriptExpressionNode;//E
struct CallExpressionNode;//I
struct AdditiveExpressionNode;//E
struct MultiplicativeExpressionNode;//I
struct RelationalExpressionNode;//E
struct UnaryExpressionNode;//I
struct IntegerLiteralExpressionNode;//E
